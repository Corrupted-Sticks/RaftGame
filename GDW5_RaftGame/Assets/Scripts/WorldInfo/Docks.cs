...
namespace SDS_Locations
{
    ...
    public static class Locations
    {
        ...
        public static Dictionary<Docks, Vector3> IslandPositions = new Dictionary<Docks, Vector3>{
            {Docks.Dock1, new Vector3(-130,58,-450) },
            {Docks.Dock2, new Vector3(-240,58,132) },
            {Docks.Dock3, new Vector3(-507,58,-148) },
            {Docks.Dock4, new Vector3(34,58,171) },
            {Docks.Dock5, new Vector3(10,58,-155) },
            {Docks.Dock6, new Vector3(-303,58,318) },
            {Docks.Dock7, new Vector3(-520,58,222)},
            {Docks.Dock8, new Vector3(-31,58,300) },
            {Docks.Dock9, new Vector3(-191,58,360) },
            {Docks.Dock10, new Vector3(-366,58,270)},
            {Docks.Dock11, new Vector3(325,58,155) },
            {Docks.Dock12, new Vector3(-310,58,-301) },
            {Docks.Dock13, new Vector3(-18,58,-328) },
            {Docks.Dock14, new  Vector3(186,58,-275)},
            {Docks.Dock15, new  Vector3(-28,58,-76)},
            {Docks.Dock16, new Vector3(-386,58,-130) },
